...
class CatalogMediaUploader
{
     ...
     * @param   int     $cmodvalue
     */
    function CatalogMediaUploader( $uploadDir, $allowedMimeTypes, $maxFileSize = 0, $maxWidth = null, $maxHeight = null ,$extendmimetypes = null )
    {
        ...
        if( is_array($extendmimetypes) && !empty($extendmimetypes)){
            foreach ($extendmimetypes as $k=>$v) {
                $this->extensionToMime[$k] = $v;
            }
        }
