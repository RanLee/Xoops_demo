...
class CatalogAttachment extends XoopsObject
{
...
class CatalogAttachmentHandler extends XoopsPersistableObjectHandler
{
    function __construct(&$db){
        parent::__construct($db, 'catalog_attachment', 'CatalogAttachment', 'att_id', 'att_filename');
    }
