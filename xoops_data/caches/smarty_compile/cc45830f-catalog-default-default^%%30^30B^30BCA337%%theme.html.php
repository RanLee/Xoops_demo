<?php /* Smarty version 2.6.28, created on 2015-08-04 05:22:17
         compiled from D:/wamp/www/Xoops_demo/themes/default/theme.html */ ?>
...
" />
    ...
    <!-- Rss -->
    <link rel="alternate" type="application/rss+xml" title="" href="<?php echo 'http://localhost/Xoops_demo/backend.php'; ?>" />

    <!-- Favicon -->
    <link rel="shortcut icon" type="image/ico" href="<?php 
echo 'http://localhost/Xoops_demo/themes/default/icons/favicon.ico'; ?>" />
    <link rel="icon" type="image/png" href="<?php 
echo 'http://localhost/Xoops_demo/themes/default/icons/favicon.png'; ?>" />

    <!-- Sheet Css -->
    <link rel="stylesheet" type="text/css" media="all" title="Style sheet" href="<?php echo 'http://localhost/Xoops_demo/xoops.css'; ?>" />
    <link rel="stylesheet" type="text/css" media="all" title="Style sheet" href="<?php 
echo 'http://localhost/Xoops_demo/themes/default/style.css'; ?>" />
	<!--[if lte IE 8]>
		<link rel="stylesheet" href="<?php 
echo 'http://localhost/Xoops_demo/themes/default/styleIE8.css'; ?>" type="text/css" />
	<![endif]-->
...
<table cellspacing="0">
    <tr id="header">
        <td id="headerlogo"><a href="<?php echo 'http://localhost/Xoops_demo/'; ?>" title="<?php echo $this->_tpl_vars['xoops_sitename']; ?>
"><img src="<?php 
echo 'http://localhost/Xoops_demo/themes/default/xoops-logo.png'; ?>" alt="<?php echo $this->_tpl_vars['xoops_sitename']; ?>
" /></a></td>
